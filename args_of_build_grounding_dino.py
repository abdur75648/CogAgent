# Taken directly from the original output of ChatterBox
from argparse import Namespace
args = Namespace(config_file='groundingdino/util/cfg_odvg_swinbase.py',
    version='REMOVE-THIS-llava-llama-2-13b-chat-lightning-preview',
    datasets=None,
